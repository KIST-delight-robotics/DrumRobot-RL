# source/extensions/drum_robot/drum_robot/tasks/legacy_task/dr_cfg.py
...
class DrumRobotEnvCfg(DirectRLEnvCfg):
    ...
    # 타격 체크 파라미터
    drum_xy_range: float = 0.1
    drum_z_margin: float = 0.1
    min_impact_velocity: float = 1.0
    min_rebound_velocity: float = 0.3
    ...
    rew_w_action = 0.0005
    rew_w_joint_vel = 0.00005
    rew_w_limit = 1.0

    success_bonus = 50.0
    limit_margin = 10.0 * math.pi / 180.0
