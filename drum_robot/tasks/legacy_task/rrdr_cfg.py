...
class DrumRobotEnvCfg(DirectRLEnvCfg):
    ...
    drum_z_range: float = 0.10
    min_impact_velocity: float = 0.1
    ...
    # 팁의 대기 위치 [x, y, z, theta0]
    idle_pos = (-0.100, 0.361, -0.380, 10.0*math.pi/180)  # 스네어 위치에서 z +10cm
