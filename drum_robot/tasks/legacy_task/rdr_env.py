...
from .rdr_cfg import DrumRobotEnvCfg
...
class DrumRobotEnv(DirectRLEnv):
    ...
    def _load_config(self):
        ...
        self.idle_tip_pos = torch.tensor(self.cfg.idle_tip_pos, device=self.device).unsqueeze(0)    # (1, 3)
        self.idle_tip_pos[:, 2] = self.idle_tip_pos[:, 2] + self.cfg.robot_waist_joint_offset_z
